  ...
  <v-container>
    <v-row class="text-center">
      <v-col cols="12" justify-center>
        <v-img
          :src="require('../assets/irvshapiro500.png')"
          class="my-3"
          contain
          height="200"
        />
    ...
    <v-row class="text-center">
      <v-col class="mb-4" cols="12" justify-center>
    ...
    <v-row class="text-center">
      ...
      <v-col class="mb-4" cols="8" justify-center>
        ...
        <p>
          In the past few years a plethora of new inexpensive desktop
          manufacturing tools have become available. Ranging from 3d printers to
          single board computers the size of a quarter these devices are
          revolutionizing our ability as hobbiest and entrepenuers to create
    ...
    <v-row class="text-center">
      ...
      <v-col class="mb-4" cols="8" justify-center>
        <p class="subheading font-weight-regular">
          To learn about me and my background please visit, my personal website
          <a href="https://cogitations.com" target="_blank">Cogitations</a>
        </p>
      </v-col>
      <v-spacer />
    </v-row>
